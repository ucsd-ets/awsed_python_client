...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[ApiErrorResult, UserResultJson]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[ApiErrorResult, UserResultJson]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    client: Client,
) -> Response[Union[ApiErrorResult, UserResultJson]]:
...
def sync(
    ...
    *,
    client: Client,
) -> Optional[Union[ApiErrorResult, UserResultJson]]:
    """Describe a user by username
    ...
    Returns:
        Union[ApiErrorResult, UserResultJson]
    """
